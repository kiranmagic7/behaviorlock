...
check:
	...
	sh -n runner/*.sh scripts/*.sh testdata/control-runner/*.sh testdata/tracer-death/*.sh testdata/tracer-failure/*.sh
	command -v shellcheck >/dev/null
	shellcheck runner/*.sh scripts/*.sh testdata/control-runner/*.sh testdata/tracer-death/*.sh testdata/tracer-failure/*.sh
	./scripts/test-dco.sh
